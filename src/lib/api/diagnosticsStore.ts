...
const DEFAULT_PROVIDERS: ProviderDiagnostic[] = [
  ...
  { providerId: 'reverseGeocoding', providerName: 'Location Names (BigDataCloud)', status: 'idle' },
  ...
  { providerId: 'markets', providerName: 'Finnhub generated market snapshot', status: 'idle' },
